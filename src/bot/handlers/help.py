...
async def cmd_help(message: types.Message) -> None:
    await message.answer(
        ...
        "<b>━━ Account ━━</b>\n"
        "/register — Register (required, gives 10 free searches)\n"
        "/redeem <b>[key]</b> — Redeem premium key for unlimited\n"
        "/userinfo — Check your usage & premium status\n"
        ...
        "/genkey <b>[duration]</b> — Generate premium keys\n"
